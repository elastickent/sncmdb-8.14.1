...
FLOAT_FIELD_MAPPING = {"type": "float"}
...
SNCMDB_FIELD_MAPPINGS = {
    ...
    "sscl.day": DATE_FIELD_MAPPING,
    "sscl.runtime.nist": FLOAT_FIELD_MAPPING,
    "sscl.runtime.total": FLOAT_FIELD_MAPPING,
    "sscl.runtime.ufortify": FLOAT_FIELD_MAPPING,
}
